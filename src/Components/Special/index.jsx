...
const cardsData = [
  ...
  },
  {
    ...
    description: "At Adane International, we're here for every special occasion. With our Special Occasions package, we'll help you celebrate life's biggest milestones in style.Make your special moments truly unforgettable with our Special Occasions package.",
  },
];
        ...
        {cardsData.map((card, index) => (
          <Grid item key={index}>
            ...
            >
              ...
              />
              <CardContent>
                <Typography gutterBottom variant="h5" component="div" sx={{color:'gold', fontWeight:'bold'}}>
                  {card.title}
                </Typography>
